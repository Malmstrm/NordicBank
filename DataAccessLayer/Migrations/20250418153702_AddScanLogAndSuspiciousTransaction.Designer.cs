...
{
    [DbContext(typeof(NordicBankAppDataContext))]
    [Migration("20250418153702_AddScanLogAndSuspiciousTransaction")]
    partial class AddScanLogAndSuspiciousTransaction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccessLayer.Models.ScanLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAccessLayer.Models.SuspiciousTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAccessLayer.Models.SuspiciousTransaction", b =>
                {
                    b.HasOne("DataAccessLayer.Models.ScanLog", "ScanLog")
                        .WithMany("SuspiciousTransactions")
                        .HasForeignKey("ScanLogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ScanLog");
                });
            ...
            modelBuilder.Entity("DataAccessLayer.Models.ScanLog", b =>
                {
                    b.Navigation("SuspiciousTransactions");
                });
